...
surface_size = 1000
main_surface = pygame.display.set_mode((900,900),pygame.DOUBLEBUF)
...
def draw_tree(inord, order, theta, thetab, sz, posn, heading, color=(0,0,0), depth=0):
   ...
   delta_x = trunk * math.sin((heading*1j*400/400).imag)
   ...
   gradd  = 128+(127*math.cos((heading*1).real))
       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i in (decoded_oh):
                  ...
                  theta1 = math.cos(2*math.pi*(i/2147483647))*1*(math.pi*(pygame.mouse.get_pos()[1]/225))
                  theta2 = math.sin(2*math.pi*(i/2147483647))*1*(math.pi*(pygame.mouse.get_pos()[1]/450))

                  #theta1 = math.cos(2*math.pi*(i/2147483647)*1)
                  ...
                  draw_tree(inord,6, theta1, theta2, surface_size*0.15, (450,225), (math.pi*(i/2147483647)))
                  #draw_tree2(inord,4, theta1, theta2, surface_size*0.2, (450,450), (math.pi*(i/2147483647)))
                  #draw_tree3(inord,3, theta1, theta2, surface_size*0.2, (450,450), (math.pi*(i/2147483647)))
                  #draw_tree4(inord,3, theta1, theta2, surface_size*0.2, (450,450), (math.pi*(i/2147483647)))
