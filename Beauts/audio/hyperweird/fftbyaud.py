...
surface_size = 1000
main_surface = pygame.display.set_mode((1640,680),pygame.DOUBLEBUF)#+pygame.FULLSCREEN)
...
def draw_tree(inord, order, theta, thetab, sz, posn, heading, color=(0,0,0), depth=0):
   ...
   gradd2 = 128+(128*math.sin((heading*1j).imag))
       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i in (decoded_ohh):
                  ...
                  theta1 = math.sin(2*math.pi*(i/2147483647))*(1*(pygame.mouse.get_pos()[0]/225))
                  ...
                  draw_tree(inord,5, theta1, theta2, surface_size*0.3, (820,340), (math.pi*(i/2147483647)))
