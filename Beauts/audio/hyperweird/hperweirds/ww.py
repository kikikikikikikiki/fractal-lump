...
def draw_tree(inord, order, theta, thetab, sz, posn, heading, color=(0,0,0), depth=0):
   ...
   delta_y = trunk * math.sin((heading**2).real)
   delta_x = trunk * math.cos((heading**2).real)
       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i in (decoded_ohh):
                  ...
                  draw_tree(inord,3, theta1, theta2, surface_size*0.3, (800,450), (math.pi*(i/2147483647)))
