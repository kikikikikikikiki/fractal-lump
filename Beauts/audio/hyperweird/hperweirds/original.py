       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i,j in zip(decoded_ohh,decoded_oh2):
                  ...
                  theta1 = math.sin(2*math.pi*(i/2147483647))*math.cos(2*math.pi*((i/2147483647)))*(math.pi+(math.pi*(j/2147483647)))#(1*(pygame.mouse.get_pos()[0]/450))
                  ...
                  draw_tree(inord,3, theta1, theta2, surface_size*0.25, (500,750), (math.pi*(j/2147483647)))
