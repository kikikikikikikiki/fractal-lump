...
def draw_tree(inord, order, theta, thetab, sz, posn, heading, color=(0,0,0), depth=0):
   ...
   delta_y = trunk * calc_fourier_seriesx(heading)
   delta_x = trunk * calc_fourier_seriesy(heading)
   thetaj = theta*1j*1j
   thetai = thetab*1j*1j
       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i in (decoded_oh):
                  ...
                  theta1 = ((math.sin(2*math.pi*(i/2147483647)))*math.cos(2*math.pi*(i/2147483647)))**math.sin(2*math.pi*((i/2147483647)))**(1*(pygame.mouse.get_pos()[0]/900))
                  ...
                  draw_tree(inord,4, theta1, theta2, surface_size*0.3, (400,450), (math.pi*(i/2147483647)))
