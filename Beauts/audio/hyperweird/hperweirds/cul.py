       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i,j in zip(decoded_ohh,decoded_oh2):
                  ...
                  theta1 = math.sin(2*math.pi*(i/2147483647))*math.cos(2*math.pi*((i/2147483647)))*(math.pi+(math.pi*(j/2147483647)))+1j**(10j*(j/2147483647))#(1*(pygame.mouse.get_pos()[0]/450))
                  ...
                  draw_tree(inord,6, theta1, theta2, surface_size*0.4, (500,500), (math.pi*i/2147483647))
