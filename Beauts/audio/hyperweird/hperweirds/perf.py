       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i,j in zip(decoded_ohh,decoded_oh2):
                  ...
                  draw_tree(inord,2, theta1, theta2, surface_size*0.4, (500,500), (4*math.pi*(math.sin(i/2147483647)+math.sin(3*i/2147483647)/3+math.sin(5*i/2147483647)/5)))
