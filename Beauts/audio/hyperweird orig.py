       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i in (decoded_ohh):
                  ...
                  theta1 = math.sin(2*math.pi*(i/2147483647))+1#*math.cos(2*math.pi*((i**2/2147483647)))#(1*(pygame.mouse.get_pos()[0]/450))
                  theta2 = math.sin(2*math.pi*((i**2/2147483647)))+1j*math.sin(2*math.pi*((i**2/2147483647)))#*(1*(pygame.mouse.get_pos()[0]/450))
