...
surface_size = 1000
main_surface = pygame.display.set_mode((600,600),pygame.DOUBLEBUF)
...
def draw_tree(inord, order, theta, thetab, sz, posn, heading, color=(0,0,0), depth=0):
   ...
   delta_y = trunk * math.sin((heading*1j*400/400).imag)
   delta_x = trunk * math.sin((heading*400/400).imag)
   #print(heading)
   #pygame.display.flip()
       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i in (decoded_oh):
                  ...
                  #theta1 = math.cos((pygame.mouse.get_pos()[1]/225)*2*math.pi*(i/2147483647))*1j#(pygame.mouse.get_pos()[1])
                  #theta2 = math.cos((pygame.mouse.get_pos()[0]/225)*2*math.pi*(i/2147483647))
                  
                  theta1 = ((math.cos(2*math.pi*(i/2147483647))))*(1*(pygame.mouse.get_pos()[1]/450))*1j
                  theta2 = (math.sin(2*math.pi*(i/2147483647)))#*pygame.mouse.get_pos()[0]/450
                  ...
                  draw_tree(inord,5, theta1, theta2, surface_size*0.3, (300,300), (math.pi*i))
