...
def gameloop():
    ...
    def callback(in_data, frame_count, time_info, status):
       decoded = numpy.fromstring(in_data, dtype=numpy.int32)
       theta1 = math.sin(decoded[1]/2147483647)
       theta2 = math.sin(decoded[1]/2147483647)
       theta1 += 10+1j
       theta2 += 10+1j
       main_surface.fill((0, 0, 0))
       draw_tree(8, theta1, theta2, surface_size, (800,450), math.pi)
       pygame.display.flip()
       my_clock.tick(60)
       #print(decoded[1])
