...
surface_size = 1000
main_surface = pygame.display.set_mode((800,450),pygame.DOUBLEBUF+pygame.FULLSCREEN)
    ...
    def callback(in_data, frame_count, time_info, status):
       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               #print(decoded[0])
               for i,x,j in zip(decoded_oh,decoded2,decoded3):
                  ...
                  theta1 = math.sin(2*math.pi*(i/2147483647))**math.cos(2*math.pi*((i/2147483647)))#*((x/2147483647))#*(1*(pygame.mouse.get_pos()[0]/450))
                  theta2 = math.sin(2*math.pi*((i**2/2147483647)))*1j**math.sin(2*math.pi*((i/2147483647)))#*(1*(pygame.mouse.get_pos()[1]/450))
                  ...
                  draw_tree(inord,5, theta1, theta2, surface_size*0.5, (100,450), ((x/2147483647)))
