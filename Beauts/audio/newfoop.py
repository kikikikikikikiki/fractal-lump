...
main_surface = pygame.display.set_mode((1640*m,680*m))#,pygame.DOUBLEBUF)#+pygame.FULLSCREEN)
       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i,j in zip(decoded_ohh,decoded_oh):
                  ...
                  draw_tree(inord,6, theta1, theta2, surface_size*0.3, (820*m,340*m), (math.pi*(i/2147483647)))
