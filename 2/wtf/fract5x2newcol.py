...
def draw_tree(order, depthprint, theta, thetab, sz, clol, clol2, posn, heading, color=(125,100,150), depth=0):
   ...
   if order > 0:   # Draw another layer of subtrees
      ...
      # make the recursive calls to draw the two subtrees
         ...
         draw_tree(order-1, depthprint, theta*math.cos(heading), thetab*math.sin(heading), newsz, clol+12, clol2+12, newpos, heading+theta, color1, depth+(theta*math.sin(heading)))
         draw_tree(order-1, depthprint, theta*math.cos(heading), thetab*math.sin(heading), newsz, clol+6, clol2+6, newpos, heading+theta+12, color2, depth+(theta*math.sin(heading)))
#@lru_cache(maxsize=10000)
def gameloop():
    depthincr = 0
    theta1 = 0
    ...
    while True:
        ...
        draw_tree(12, depthprint, theta1, theta2, surface_size*0.9, colol, colol2, (0, 400), 0,color=(0,0,0), depth=depthincr)
