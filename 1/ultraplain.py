...
surface_size = 1000
main_surface = pygame.display.set_mode((1600,900),pygame.HWSURFACE+pygame.DOUBLEBUF)
...
def draw_tree(order, theta, thetab, sz, posn, heading, color=(0,0,0), depth=0):
   ...
   if order > 0:
      ...
      draw_tree(order-1, theta, thetab, newsz, newpos, (heading-theta), color2, depth+1)
...
def gameloop():
    ...
    while True:
        ...
        draw_tree(15, theta1, theta2, surface_size*1.2, (800,1200), math.pi)
