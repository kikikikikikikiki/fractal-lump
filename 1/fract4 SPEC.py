...
def draw_tree(order, theta, thetab, sz, step, clol, clol2, posn, heading, color=(0,0,0), depth=0):
   ...
   delta_x = trunk * math.cos(heading*pygame.mouse.get_pos()[0]/90)
   delta_y = trunk * math.sin(heading*pygame.mouse.get_pos()[1]/90)
   (u, v) = posn
   ...
   if order > 0:   # Draw another layer of subtrees
      ...
      # make the recursive calls to draw the two subtrees
         ...
         draw_tree(order-1, theta, thetab, newsz, step, clol+10, clol2+15, newpos, heading-theta, color1, depth)
         draw_tree(order-1, thetab, theta, newsz, step, clol, clol2, newpos, heading-theta, color2, depth+1)
