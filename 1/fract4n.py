...
def gameloop():
    ...
    while True:
        ...
        draw_tree(10, theta1, theta2, surface_size*1.1, step, colol, colol2, pygame.mouse.get_pos(), -math.pi/2, color=(0,0,0), depth=depthincr)
        draw_tree2(10, theta1, theta2, surface_size*1.1, step, colol, colol2, pygame.mouse.get_pos(), -math.pi/2, color=(0,0,0), depth=depthincr)
