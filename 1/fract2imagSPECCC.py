...
def draw_tree(order, theta, thetab, sz, clol, clol2, posn, heading, color=(0,0,0), depth=0):
   ...
   delta_x = trunk * math.sin((heading*1j).imag/5)
   delta_y = trunk * math.sin((heading*1j).real/5)
   (u, v) = posn
   ...
   if order > 0:   # Draw another layer of subtrees
      ...
      # make the recursive calls to draw the two subtrees
         ...
         draw_tree(order-1, theta, thetab, newsz, clol+12, clol2+12, newpos, (heading-theta2), color1, depth+1)
