       ...
       if math.fabs(decoded[0]) > 0:
           if math.fabs(decoded[1]) > 0:
               ...
               for i,j in zip(decoded_ohh,decoded_oh):
                  ...
                  theta1 = math.sin(math.pi*(i/2147483647))#*(2*math.pi*(j/2147483647))#(1*(pygame.mouse.get_pos()[0]/225))
                  #print(pygame.mouse.get_pos()[0]/225)
                  theta2 = math.sin(math.pi*(i/2147483647))*1j#*(1*(pygame.mouse.get_pos()[0]/450))
